...
```text
^https://github\.com/kguardian-dev/kguardian/\.github/workflows/(controller|broker|frontend|llm-bridge|evaluator)-release\.yaml@refs/tags/(controller|broker|frontend|llm-bridge|evaluator)/v[0-9]+\.[0-9]+\.[0-9]+(-[0-9A-Za-z.-]+)?$
```
