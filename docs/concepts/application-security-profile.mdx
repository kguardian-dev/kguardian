...
| `lastSyncedAt` | When the profile was last read. If the broker is unreachable the previous data stays, `ProfileAvailable` turns `False`, and its message says how old the data is. |
