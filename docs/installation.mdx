...
The assistant is optional and off by default. It is one workload — the LLM Bridge — that runs the 23 tools and the policy/seccomp generation in-process against the Broker.
