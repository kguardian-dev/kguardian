...
kguardian is built around four core components, plus an audit-mode evaluator (deployed by default) and an optional AI assistant (llm-bridge):
...
<Steps>
  ...
  <Step title="AI Assistant (Optional)">
    The optional **AI assistant** (llm-bridge) answers natural-language questions about cluster traffic and generates policies conversationally.
  </Step>
</Steps>
