...
const NamespaceSelector: React.FC<NamespaceSelectorProps> = ({
  ...
  return (
    <div className="flex items-center gap-2 bg-hubble-card px-4 py-2 rounded-lg border border-hubble-border">
      ...
      <label htmlFor="namespace" className="text-sm text-secondary font-medium">
        Namespace:
      </label>
      <select
        id="namespace"
        ...
        className="bg-hubble-dark text-primary px-3 py-1 rounded border border-hubble-border
