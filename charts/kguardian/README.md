...
| broker.supplychain.tiers.unknownExposureAsExposed | bool | `true` | Treat a workload with no captured ingress as exposed. false ranks it as internal, which can move a finding from P0 to P1 on missing data. |
