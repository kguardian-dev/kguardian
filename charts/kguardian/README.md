...
| advisor.image.tag | string | `"v1.6.0"` | Advisor version tag (auto-updated by Renovate, like the other images) |
...
| broker.image.tag | string | `"1.10.1"` | Broker version tag (auto-updated by release-please) |
...
| evaluator.image.tag | string | `"v0.3.1"` | Evaluator version tag (auto-updated by release-please) |
...
| mcpServer.image.tag | string | `"1.4.1"` | MCP Server version tag (auto-updated by release-please) |
