...
| llmBridge.image.tag | string | `"1.4.1"` | LLM Bridge version tag (auto-updated by release-please) |
...
| mcpServer.image.tag | string | `"1.5.0"` | MCP Server version tag (auto-updated by release-please) |
