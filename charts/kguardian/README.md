...
| controller.image.tag | string | `"1.9.4"` | Controller version tag (auto-updated by release-please) |
...
| evaluator.image.tag | string | `"v0.3.5"` | Evaluator version tag (auto-updated by release-please) |
...
| frontend.image.tag | string | `"1.12.0"` | Frontend version tag (auto-updated by release-please) |
...
| llmBridge.image.tag | string | `"1.7.0"` | LLM Bridge version tag (auto-updated by release-please) |
